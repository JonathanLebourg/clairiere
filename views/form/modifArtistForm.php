                    ...
                    <form method="POST" action="">
                        <div class="col s12 m4">
                            ...
                            <div class="row">
                                ...
                                <div class="modifDivProfileImg file-field input-field col s12 m9">
                ...
                <div class="col s12 m8 center-align">
                    <div class="row">
                        <div class="card white darken-1">
                            ...
                            <div class="modifDivPresent input-field col s12 m8 offset-m2">
                    ...
                    <div class="row">                           
                        <div class="card white darken-1">                 
                            <div class="col s9 m9"><p><i>Artiste <?= $artistById->speciality ?></i></p>  
                            </div>
                            <div class="col s3 m3">
                            ...
                            <div class="modifDivSpeciality input-field col s12 m8 offset-m2">
