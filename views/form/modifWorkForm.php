<?php
require 'controllers/formsCtl/modifWorkController.php';
                        ...
                        <div class="card white darken-1">
                            ...
                            <div class="card white darken-1 center-align">
                                <div class="card-content">
                                    ...
                                    <div class="card-content">
                                        <div class="row">
                                            <div class="col s12 m12">
                                                <p>Date : <i><?= $workById->date ?></i><a class="btn validateButton" name="submitDate">
                                                        <i class="tiny material-icons">mode_edit</i>
                                                    </a></p>
                                                <div class="modifDivDate input-field">
                                                    <div class="input-field col s10 offset-s1 m10 offset-m1">
                                                        <input id="date" type="text" name="date" />
                                                        <label for="date">Entrez une année</label>
                            ...
                            <div class="card white darken-1">
                                <div class="card-content">
                                    <div class="row">
                                        <div class="col s12 m12">
                                            <button class="validateButton btn" type="submit" name="submitArtworkModif">MODIFIER</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
