        ...
        <div class="row">
            <div class="card">
                <div class="card-content">
                    <div class="row">
                        <h1 class="card-title center-align"><b><?= $artistById->nickName ?></b></h1>
                        <hr>
                    </div>
                    <div class="row center-align">
                        <div class="card hoverable col s12 m4">
                            <div class="card-content">
                                <img src="./img/profilePicture/<?= $artistById->profilePicture ?>" width="150px" /> 
                                <p class="card-title center-align"><i><?= $artistById->speciality ?></i></p>
                            </div>
                        </div>
    ...
    <div class="container">
        <div class="row">
            <?php foreach ($ListArtWorkByArtist as $work) { ?>
                <div class="col s12 m4 borderWork hoverable">
                    <div class="row center-align">
                        <h2><?= $work->title ?></h2>
                        <hr>
                    </div>
                    <div class="row">
                        <a href="index.php?page=artWork&id=<?= $work->idArtWork; ?>">
                            <img src="img/artWorks/<?= $work->picture ?>"  height="150px" class="responsive-img"/></a>                    
                    </div>
                    <div class="row">
